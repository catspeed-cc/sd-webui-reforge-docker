...
def model_lora_keys_unet(model, key_map={}):
    ...
    if isinstance(model, ldm_patched.modules.model_base.Flux) or isinstance(model, ldm_patched.modules.model_base.Chroma): #Diffusers lora Flux or a diffusers lora Chroma
