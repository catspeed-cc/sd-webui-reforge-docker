...
class Omnigen2(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        return supported_models_base.ClipTarget(ldm_patched.modules.text_encoders.lumina2.LuminaTokenizer, ldm_patched.modules.text_encoders.omnigen2.te(**hunyuan_detect)) #check tokenizer after
